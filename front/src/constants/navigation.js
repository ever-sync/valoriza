export const icons = {
  ...
  'document-check': '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z" />',
...
export const menuItems = [
  { name: 'Visão Geral', icon: 'home', routeName: 'home', roles: ['administrador'] },
  { name: 'Contratos', icon: 'document-check', routeName: 'contratos', roles: ['administrador'] },
  { name: 'Fluxo de Caixa', icon: 'chart', routeName: 'fluxo-caixa', roles: ['administrador'] },
  { name: 'Relatórios', icon: 'reports', routeName: 'relatorios', roles: ['administrador'] },
  { name: 'Receitas', icon: 'folder', routeName: 'receitas', roles: ['administrador', 'contador'] },
  { name: 'Despesas', icon: 'credit-card', routeName: 'despesas', roles: ['administrador', 'contador'] },
  {
    name: 'Configurações',
    icon: 'cog',
    routeName: null,
    ...
    subItems: [
        ...
        { name: 'Configurações dos Contratos', routeName: 'configuracoes' },
    ]
  },
  {
    name: 'Cadastros',
    ...
    roles: ['administrador'],
    subItems: [
      { name: 'Pessoas Jurídicas', routeName: 'pessoas-juridicas' },
      { name: 'Pessoas Físicas', routeName: 'pessoas-fisicas' },
      { name: 'Contas Bancárias', routeName: 'bancos' },
    ]
  },
]